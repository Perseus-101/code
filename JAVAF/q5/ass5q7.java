...
class MyFrame extends JFrame implements ActionListener
{
	...
	private String years[]={"1995","1996","1997","1997","1998","1999","2000","2001","2002","2003","2004","2005","2005","2006","2007","2008","2009","2010","2011","2012","2013","2014","2015","2016","2017","2018","2019","2020","2021","2022"};
	...
	public MyFrame()
	{
		...
		term = new JCheckBox("Accept Term And Conditions.");
	...
	public void actionPerformed(ActionEvent e)
	{
		if(e.getSource()==sub)
		{
			...
			else
			{
				tout.setText("");
				resadd.setText("");
				res.setText("Please accept the"+"term and conditions..");
			}
		}
